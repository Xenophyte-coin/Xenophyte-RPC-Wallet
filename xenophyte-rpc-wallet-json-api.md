...
<table style='font-family:"Courier New", Courier, monospace; font-size:40%'>
  ...
  <tbody>
    ...
    <tr><td>/get_wallet_transaction|wallet_address|transaction_index</td><td>wallet_address|transaction_index</td><td>string | long</td><td>Return a transaction from a transaction index and a wallet address selected.</td></tr>
